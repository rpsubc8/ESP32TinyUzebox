...
#define CHESS4UZEBOX_H_
 ...
 //No existia
  ...
  void do_chess4uzebox_Setup(void);
  void do_chess4uzebox_main(void);
...
//Hay que dejar el DEMO_COUNTDOWN_TOP de la demo como estaba en 600
#define DEMO_COUNTDOWN_TOP (600)
//#define DEMO_COUNTDOWN_TOP (50)
